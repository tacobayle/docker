...
class DiameterServer:
    ...
    def start(self):
        ...
        # Added by vijayendra
        print("before sctp_conn")
        socket_connection = sctp.sctpsocket_tcp(socket.AF_INET)
        # addition by vijayendra ends
        ...
        try:
            while True:
                ...
                thread.start_new(self.handle_request, (incoming_connection, peer_address))
