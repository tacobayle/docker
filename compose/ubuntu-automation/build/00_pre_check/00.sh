#!/bin/bash
#
source /build/bash/test_if_variables.sh
#
#
echo ""
...
test_if_json_variable_is_defined .external_gw.name $jsonFile "   "
...
test_if_json_variable_is_defined .external_gw.ansible_version $jsonFile "   "
test_if_json_variable_is_defined .external_gw.avi_sdk_version $jsonFile "   "
...
#
#
if [[ $(jq -c -r .nsx $jsonFile) != "null" || $(jq -c -r .nsx $jsonFile) != '""' ]]; then
  echo ""
  echo "==> Checking NSX Variables"
  test_if_json_variable_is_defined .nsx.manager.basename $jsonFile "   "
...
#
#
if [[ $(jq -c -r .avi $jsonFile) != "null" || $(jq -c -r .avi $jsonFile) != '""' ]]; then
  echo ""
